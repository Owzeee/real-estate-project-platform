...
export default async function DeveloperProfilesPage() {
  ...
  const developer = await getDeveloperById(auth.developerProfile.id);
    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#f7f2e8_0%,#ffffff_100%)] px-6 py-12 sm:px-10">
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          ...
          description="Update the company profile that buyers see on the marketplace and keep your public brand presentation current."
        />

        <div className="mt-10 grid gap-6">
          <article className="rounded-[2rem] border border-stone-900/10 bg-white p-6 shadow-[0_20px_60px_rgba(41,37,36,0.08)]">
            ...
            <div className="mt-6 flex flex-wrap gap-4 text-sm text-stone-600">
              <span>Only your own company profile is visible in this dashboard.</span>
              <Link
